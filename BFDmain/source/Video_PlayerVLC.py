...
from PyQt5.QtWidgets import QMainWindow, QLabel, QWidget, QFrame, QSlider, QHBoxLayout, QPushButton, QVBoxLayout, QAction, QFileDialog, QApplication
import vlc
import threading
...
#         self.volumeslider.valueChanged.connect(self.setVolume)
        ...
        self.videoframe.setStyleSheet("background: black; border: 0px; padding: 0px;")
